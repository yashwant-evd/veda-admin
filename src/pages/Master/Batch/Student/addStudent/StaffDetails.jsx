...
function StaffDetails({ batchId }) {
  ...
  let localSelectedStaffs = [...selectedOptions];
  ...
  const onSubmit = async (values) => {
    let payload = {
      ...
      studentIds: localSelectedStaffs,
    };
    if (localSelectedStaffs?.length !== 0) {
      ...
      toast.error("Please select at least one staff", toastoptions);
    }
  };
